...
$cons="Select * from accion where fecha='$fecha' order by cambio ";
...
<?php if($exito==0 && $row!=0){
echo '<center><h4 class="form-signin-heading"><span lang="es">Movimientos en el sistema de inscripcion en la fecha "'.$fecha2[2].' de '.$mes.' del '.$fecha2[0].'"</span></h4></br></br></center>';
...
echo  "<td><b><center>Accion realizada</center></b></td>"; 
echo sprintf("</tr>");
...
if($row==0){
echo '<center>No existen movimientos en el sistema para esa fecha. si deseas volver presiona aqui <a href="por_fecha.php">aqui</a></center></br></br>';
}
if($exito==1){
