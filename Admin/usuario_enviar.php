...
<html lang="es">
  <head>
    ...
    <title>Movimientos por usuario</title>
...
$cons="Select * from accion where id_usuario='$fecha' order by cambio";
...
echo '<center><h4><span lang="es">Movimientos en el sistema de inscripcion del usuario "'.$fecha.'"</span></h4></center>';
echo '</br></br>';
...
if($row==0){
echo '<center>No existen movimientos en el sistema por ese usuario. Si deseas volver presiona <a href="por_usuario.php">aqui</a></center></br></br>';
}
if($exito==1){
