...
<h3><P class="text-center">Constancia de Retiro</P></h3>

<div class="col-lg-12 col-sm-12 planilla">

<P class="text-justify">Quien suscribe Director(e) <?php echo $nuevo2; ?> titular de la la Cédula de Identidad N° <?php echo $resultado['ced_dir']; ?>; Director(e) del <?php echo $resultado['nombre']; ?> que funciona en Valle de la pascua Edo. Guarico, hace constar que el alumno <?php echo $nuevo; ?> Titular de la Cédula de Identidad V-<?php echo $resultado['ced_e']; ?> Nacido el <?php echo $fecha2[2]; ?> de <?php echo $mes; ?> de <?php echo $fecha2[0]; ?> en la Ciudad de <?php echo $resultado['lugar_nac']; ?> <? echo $resultado['estado']; ?> fue retirado del plantel por el siguiente motivo <?php echo $resultado['motivo']; ?> en la escolaridad <?php echo date('Y'); ?> - <?php echo date('Y')+1; ?>. 
<br><br>
