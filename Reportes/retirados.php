...
<html lang="es">
  <head>
    ...
    <title>Lista de retirados</title>
...
$cons="Select * from estudiante where condicion like 'Retirado'";
...
<?php if($s!=0 && $exito==1){
echo '<center><h2 class="form-signin-heading"><span lang="es">Lista de estudiantes retirados</span></h2></br></br></center>';
...
echo '<p>';
echo '<tr>';
echo "<th scope='col'><center>V-<a href=../Consultas/consulta_estudiante.php?cedulae=".$ced.">$ced</a></center></th>";
...
echo '<center></br></br>No existen estudiantes retirados.</center></br></br>';}
if($exito==0){
